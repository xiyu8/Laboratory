...
public class Type3entity extends Entity implements CompoundButton.OnCheckedChangeListener, TextView.OnEditorActionListener {
    public Type3entity(Context context) {
        super(context);
    }

    @Override
    public int getItemViewType(int position) {
        return R.layout.z_type3entity_layout;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        //准备View 和 data
        CheckBox check_box = holder.itemView.findViewById(R.id.type3_check_box);
