...
public class NioPeriodChronicService extends Service {
    ...
    private void nioDisconnect() {
        ...
        if (!(mSocketChannel.isConnected())) {
            ...
            if(view!=null) view.showConnection(null, null, null);
            return;
        }
        try {
            mSocketChannel.close();
    ...
    private void nioConnect(String host, String port,String userName) {
        this.host = host;
        this.port = port;
    ...
    public void nioHandleReadChannel(SelectionKey selectionKey, SocketChannel socketChannel) {
        try {
            if (!isAuth) {
                ...
                if(view!=null) view.showConnection(host,port,userName);
            } else {
    ...
    public class NioBinder extends Binder {
        ...
        public void nioConnect(String host,String port,String userName) {
            NioPeriodChronicService.this.nioConnect( host, port,userName);
        }
    ...
    public interface View {
        ...
        void showConnection(final String ip, final String port, final String user);
    }
