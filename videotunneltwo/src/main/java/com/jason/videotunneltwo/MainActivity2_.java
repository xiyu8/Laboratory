...
public class MainActivity2_ extends AppCompatActivity implements NioPeriodChronicService.View {
    ...
    private void nioConnect() {
        ...
        bindService(new Intent(this, NioPeriodChronicService.class), new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                nioBinder.registerNIoSelector(MainActivity2_.this);
    ...
    protected void onResume() {
        ...
        if (resumeCount == 2) {
            bindService(new Intent(this, NioPeriodChronicService.class), new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    nioBinder = (NioPeriodChronicService.NioBinder) service;
                    nioBinder.setView(MainActivity2_.this);
                }
